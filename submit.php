...
$keyapi = 'API_KEY:SECRET_KEY'; //write YOUR API KEY
...
if(isset($_POST['submit']))
    {
        ...
        $symbol=strtoupper($symbol0.$symbol1);
...
$query = mysqli_query($connection,"INSERT INTO trade2(price,sellprice,quantity,date,clientOrderId,type,lastbal,currency,pair) VALUES 
('$priceask','$sell','$quantity123','$date','$bid123','0','$balance0','$symbol0','$symbol')");
...
echo "---------------------------------";
    ...
    echo "<a href=index.php>Place another buy order</a>";
    ?></center>
    </body></html>
