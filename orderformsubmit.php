...
if(isset($_POST['submit']))
    {
        ...
        $sell0 = $base+$base*$sellprice1/100; $sell = number_format($sell0,11);
...
?>
<?php //coin bal 
 $chbal0 = curl_init('https://api.hitbtc.com/api/2/trading/balance'); 
 curl_setopt($chbal0, CURLOPT_USERPWD, 'cHxtLRjcqNVLu7_rZiORQMtbkhD-ZilR:trkn4Y8t3KxpJUVvJjoZRTnkfSnHp-5K'); // API AND KEY
...
echo "---------------------------------";
    ...
    echo "<a href=orderform.php>Place another buy order</a>";
    ?></center>
    </body></html>
